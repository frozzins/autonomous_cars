...
\subsection{Identifying gap in the research}


This subchapter describes the primary research question addressed in the dissertation. It explains motivation for the study and how it arose from the gap identified in the current state of knowledge. Furthermore, it lays down all aims and objectives covered within the scope of the project and supports their relevance with literature discussed in previous sections.
...
The main aim of the research is trying to predict what will happen when autonomous cars are introduced to traditional traffic. Results obtained are analysed from the point of view to traffic parameters such as velocities, densities and congestion as well as from the point of view of individual drivers. The study will look into how humans interact with other humans and how it compares to interaction between two different types of vehicles.
...
\par
Creating a model of autonomous car:
In order conduct the study a simplified model of autonomous car will have to be created. It is important to note that the development of such a model derives from the needs of the primary study and is not a topic of interest itself. Once the right model is established it will remain constant through the whole experiment. The algorithm governing the model will derives from well established principles of common car-following models.

\par

Creating a realistically behaving model of human car:
The necessary part of the project is modelling a behaviour of a car controlled by experiemnt participants with keyboard arrow keys





the research does not attempt to develop a model 


of autonomous vehicle that .



The research focuses on analysing particular interactions between two vehicles and on 
...
The main objective of the research is conducting an experiment involving human participants.  

 

that would be be optimized for interactions with othjer cars. Instead 


It was hoped to observe 

Although this study does not attempt to develop the model of autonomous car 
...
The study on the topic is incredibly vast.  


Large sums of money are channelled for various projects 


Although the topic of autonomous cars is studied very widely and the amount of literature is enormous 



this dissertation attempts to identify potential gap in developing a broad understanding of how autonomous vehicles may impact traffic flow. 


Although the topic of autonomous cars is studied very widely and the amount of literature is enormous this dissertation attempts to identify potential gap in developing a broad understanding of how autonomous vehicles may impact traffic flow. 



explains the main motivation behind the study. It states the primary research question and explains why it is important 

and explains its significance supported by the sources with given in previous sections. It also says precisely what are aims and objectives of the research.

 It identifies the gap in the current research.  


and explains its significance supporting by sources 


It attempts to identify the potential gap in the 
 
It identifies potential gap in the field of study and supporting with the 



\par

short version of research question:
...
As it was shown inprevious sections the 
-autonomous cars are super important
-w cholere kasy jest na to przeznaczane
-there is planty of literaute
- 
- bardzo duzo focusu idzie w technologie -najwiecej


-nie wiele sie poswieca na interacje miedzy kierowcami
-not much study on this topic
-aby miec jak njawiecej korzyscu z wprowadzenia aut autonomicznych trzeba je zoptymalizowac do interacji z czlowiekiem

...
\subsubsection*{Learning how to drive}
...
\center{\includegraphics[width=1\linewidth]{materials/research_methodology/map_0_arrows.png}}
...
\begin{figure}[] % Example image
\center{\includegraphics[width=1\linewidth]{materials/research_methodology/map_1_arrows.png}}
\caption{Map used in First scenario. It featured figure of eight shape. There were no road splits and cars had to follow each other. Dimensions are given in meters. Covering the whole map at full speed of 15m-s would take 22 seconds.}
...
Scenario 3 aimed at microscopic interaction between particular groups of vehicles. The map used in this scenario was much more complex than previous one (Figure~\ref{fig:map_3_arrows}). The amount of human-controlled cars was equal to the number of autonomous cars. The total density of all vehicles was two times lower that previous scenarios but because of multiple intersections the number of interactions stayed high.


\begin{figure}[] % Example image
\center{\includegraphics[width=1\linewidth]{materials/research_methodology/map_3_arrows.png}}
\caption{Map used in the third scenario. It featured two road splits where drivers could change direction, 2 diagonal intersections,a 3-way intersection and 2 road accesses(?). The total length of all segments was 875 m. Travelling at 15m-s it would take 59 seconds to cover that distance. This was the longest track in the experiment.}

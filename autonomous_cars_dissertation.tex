...
Each scenario describes configuration of map, number of human drivers, number of autonomous cars, initial position of each car and length of the simulation. 
Due to uknown..

Some of these parameters could be set just before the experiment commenced

...
After initial trials with each approach, second one was chosen for implementation. As it quickly turned out the main challenge was limited computational power of computers. One iteration could not last longer than 0.0625 s and preparing image was only one of the tasks that had to be executed in that time.

 (the frame rate was limited from 20 in later stages of implementation due to Server Application performance reasons)

 of this approach 


As it was described before the 

Presenting 

The information presented to experiment participants 

...
Details of the implementation of network communication are described in the chapter "Communication between machines".
...
say about heaving objective similar to the whole software such as: portability, effiency, scalability.. ble ble ble


Using Robot Operating System was considered 

MATLAB Robotic Systems Toolbox


The fact that MATLAB 


The fact that MATLAB 


 for all applications within the project. 
...
Arriving to the final network solution 

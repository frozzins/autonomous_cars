...
\par
This sub-chapter attempts to identify the main challenges that has to be overcame in following years. Apart from necessary technological advancement discussed in previous sections it covers factors such as legislation, safety and public acceptance of autonomous cars.


\paragraph{Law regulations on autonomous driving}

The current state of Legislation does not allow to lunch fully Autnomous cars on the roads. But that;s fine because there arent any fully autonomous ones yet


\par
Currently one of the main documents defining the law applicable to autonomous cars is Vienna Convention on Road Traffic. It stays that 'every driver shall at all times be able to control his vehicle'. This means that as long as this document remains in power, fully autonomous driving will not be possible \citep{vienna1}. However, the UK government has never signed the Conventions that was accepted by multiple countries around the world including majority of European countries. Therefore, UK is likely to be in the forefront in the development of autonomous driving \citep{telegraph}.
\par

Figure shows counties that 
...
As it is exmaplned later the matter discussed in dthis sections leys fundaments for the main reserach question of this Dissertation.
